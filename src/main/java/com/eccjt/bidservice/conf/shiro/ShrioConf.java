...
public class ShrioConf {
    ...
    // 当前工程对外提供的服务地址
    public static final String shiroServerUrlPrefix = "http://localhost:8001";
    ...
    // 登录成功地址
    public static final String loginSuccessUrl = "/subject";
    // 权限认证失败跳转地址
...
//      <!-- 用户授权/认证信息Cache, 采用EhCache 缓存 -->
    ...
    public ShiroFilterFactoryBean getShiroFilterFactoryBean(DefaultWebSecurityManager securityManager, CasFilter casFilter, SysUserMapper sysUserMapper) {
        ...
        loadShiroFilterChain(shiroFilterFactoryBean, sysUserMapper);
